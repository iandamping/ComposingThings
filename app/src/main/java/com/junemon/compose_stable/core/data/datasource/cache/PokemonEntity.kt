...
@Entity(tableName = "cache_pokemon")
data class PokemonEntity(
    @PrimaryKey
    @ColumnInfo(name = "pokemon_primary_id") val pokemonPrimaryId: Int?,
    ...
    @ColumnInfo(name = "pokemon_type1") val pokemonType1: String? = null,
    @ColumnInfo(name = "pokemon_species_url") val pokemonSpeciesUrl: String,
    @ColumnInfo(name = "pokemon_time_stamp") val timestamp: Long,
)