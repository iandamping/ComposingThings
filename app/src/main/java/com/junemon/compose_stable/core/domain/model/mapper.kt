...
import com.junemon.compose_stable.core.domain.response.PokemonStat
import com.junemon.compose_stable.util.PokemonConstant.ONE_EGG_MONS
...
fun PokemonDetail.mapToDatabase(): PokemonEntity = PokemonEntity(
    pokemonPrimaryId = null,
    pokemonId = pokemonId,
    pokemonWeight = pokemonWeight,
    pokemonHeight = pokemonHeight,
...
fun List<PokemonDetail>.mapListToDatabase() = map { it.mapToDatabase() }